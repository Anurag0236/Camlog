...
const TakeAttendancepage = () => {
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.post(
        "http://localhost:5050/api/user/student/getstudentenr",
        {
          classid: id,
        }
      );
  ...
  useEffect(() => {
    const createattendancereport = async () => {
      try {
        const response = await axios.post(
          "http://localhost:5050/api/user/createattendancereport",
  ...
  useEffect(() => {
    ...
    const lengthreport = async () => {
      try {
        ...
        const response = await axios.post(
          "http://localhost:5050/api/user/getreportlength",
          { classid: id }
        );
  ...
  useEffect(() => {
    const markpresent = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          "http://localhost:5050/api/user/updatereport",
  ...
  useEffect(() => {
    const fetchClassroomName = async () => {
      try {
        const response = await axios.post(
          "http://localhost:5050/api/user/getclass",
          { id }
        );
